...
export const environment = {
  production: false,
  APIEndpoint: 'https://myplanner.in/futurewise/api/v1/web/',
  GmailAPIEndpoint: 'https://myplanner.in/email-server/api/v1/web/',
  TransactionPlatform: 'https://myplanner.in/transaction-platform-new/api/v1/web/',//'http://192.168.0.9:8080/transaction-platform/api/v1/web/',
