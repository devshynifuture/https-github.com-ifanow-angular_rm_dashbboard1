...
export const componentList = [AddLiabilitiesComponent, AddInsuranceComponent, FixedDepositComponent,
  ...
  OthersComponent, CashInHandComponent, BankAccountsComponent, AddGoalComponent, NpsSchemeHoldingComponent,LiabilitiesDetailComponent,MfAlllocationComponent 
];
