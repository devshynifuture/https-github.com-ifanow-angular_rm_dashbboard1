export const appConfig = {
  ...
  FILTER_DATA: 'mutual-fund/mutualFundTransaction/filtered/list/get',
  SEARCH_DATA: '',
  ...
  MAP_CLIENT: 'user/client/advisor/map/multiple',
  ///////////////////foliodetails///////////////////////////
  ...
  GET_INCOME_COUNT: 'account/income/count/get',
  GET_BUDGET_COUNT: 'account/expense/budget/count/get',
  GET_EXPENSE_COUNT: 'account/expense/count/get',
  ...
  ADD_OTHERS_ASSETS: 'account/asset/other-asset/add',
  ...
  DELETE_SOVEREIGN_GOLD_BOND_TRANSACTION: 'account/asset/sovereign-gold-transaction/delete',
  DELETE_SOVEREIGN_GOLD_BOND: 'account/asset/sovereign-gold/delete',
  ...
  DELETE_OTHERS_ASSETS: 'account/asset/other-asset/delete',
  ...
  GET_LOGIN_DATA_FROM_UUID: 'user/login/with/uuid',
  ...
  GENERAL_INSURANCE_SUGGEST_POLICY: 'insurance/planning/gen/insurance/suggest-policy/get?',
  UPDATE_CURRENT_POLICY_GI: 'insurance/planning/general/insurance/need/analysis/current-policies/insert',
  ...
  BACKOFFICE_RM_RECALCULATE_BALANCE_UNITS: 'backoffice/recalculate/balance/unit',
  BACKOFFICE_MERGE_SCHEME_CODE: 'backoffice/merge/schemes',
  BACKOFFICE_MERGE_SCHEME_CODE_BULK: 'backoffice/merge/schemes/bulk/level',
  ...
  GET_CLIENT_INFO_BASED_ON_USERNAME: 'user/client/detail-using-uuid/get',
  RESET_LINK_EXPIRE: 'user/client/reset-link/expire',
  ...
  REMOVE_ACCESS_RIGHT: 'setting/users-roles/access-rights/remove',
  ////////////////////////////// calendar////////////////////////////////////////////
