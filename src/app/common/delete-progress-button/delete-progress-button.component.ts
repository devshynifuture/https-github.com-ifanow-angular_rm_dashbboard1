...
@Component({
  selector: 'app-delete-progress-button',
  templateUrl: './delete-progress-button.component.html',
  styleUrls: ['./delete-progress-button.component.scss']
})
export class DeleteProgressButtonComponent implements AfterViewInit, OnInit {
  islogBut = false;
