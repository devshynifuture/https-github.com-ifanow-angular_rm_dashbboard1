import { Component, OnInit, ViewChildren, QueryList, Input, Inject } from '@angular/core';
import { MatProgressButtonOptions } from '../progress-button/progress-button.component';
...
export class RealEstatePropertyComponent implements OnInit {
  ...
  constructor(public custumService: CustomerService, public subInjectService: SubscriptionInject,
    public dialogRef: MatDialogRef<RealEstatePropertyComponent>, private fb: FormBuilder, public custmService: CustomerService,
    public eventService: EventService, public utils: UtilService,
    public enumService: EnumServiceService, @Inject(MAT_DIALOG_DATA) public fragmentData: DialogData) {
  ...
  ngOnInit() {
    if (this.fragmentData.isRealEstate) {
      this.getRealEstate('');
    }
