...
export class OrgSettingServiceService {
  ...
  getEmailVerificationReports(data) {
    ...
    return this.http.get(apiConfig.MF_URL + appConfig.GET_EMAIL_VERIFICATION_REPORT, data);
  }
  ...
  editPreEmailTemplate(data) {
    ...
    return this.http.put(apiConfig.MF_URL + appConfig.SAVE_EMAIL_ID_REPORT, data);
  }
