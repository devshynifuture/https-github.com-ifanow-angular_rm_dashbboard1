...
@Component({
  selector: 'app-plan-return-inflation',
  templateUrl: './plan-return-inflation.component.html',
  styleUrls: ['./plan-return-inflation.component.scss']
})
export class PlanReturnInflationComponent implements OnInit {
