...
@Component({
  selector: 'app-setting-activity-task-templates',
  templateUrl: './setting-activity-task-templates.component.html',
  styleUrls: ['./setting-activity-task-templates.component.scss']
})
export class SettingActivityTaskTemplatesComponent implements OnInit {
