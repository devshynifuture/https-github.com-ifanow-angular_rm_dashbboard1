...
export class SwitchTransactionComponent implements OnInit {
  ...
  selectedFolio(folio) {
    ...
    this.switchTransaction.controls.currentValue.setValue(this.processTransaction.calculateCurrentValue(this.navOfSelectedScheme, folio.balanceUnit))
    this.currentValue = this.processTransaction.calculateCurrentValue(this.navOfSelectedScheme, folio.balanceUnit);
    this.switchTransaction.controls.balanceUnit.setValue(folio.balanceUnit)
    this.showUnits = true;
