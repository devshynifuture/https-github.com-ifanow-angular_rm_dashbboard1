...
import { AddEditSubscriptionIncomeComponent } from './subscription/invoices-subscription/add-edit-subscription-income/add-edit-subscription-income.component';
...
export const componentList = [
  ...
  AddEditSubscriptionIncomeComponent
]
