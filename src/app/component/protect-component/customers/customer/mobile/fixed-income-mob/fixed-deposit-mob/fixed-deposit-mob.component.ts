...
import { ActiityService } from 'src/app/component/Services/actiity.service';

@Component({
  selector: 'app-fixed-deposit-mob',
  templateUrl: './fixed-deposit-mob.component.html',
  styleUrls: ['./fixed-deposit-mob.component.scss'],

})
export class FixedDepositMobComponent implements OnInit {
  ...
  ngOnInit() {
    // this.fixedDeposit.value.getCoOwnerName =[]
  ...
  saveFixedDeposit() {
    ...
    if ((!this.tenureValid && this.fixedDeposit.value.maturity != '2')) {
      // this.reqError = true;
      ...
      const obj = {
        ...
        userBankMappingId: this.fixedDeposit.controls.bankACNo.value,
