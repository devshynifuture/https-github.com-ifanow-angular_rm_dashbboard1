...
import { SubscriptionService } from 'src/app/component/Services/subscription.service';

@Component({
  selector: 'app-add-edit-bank-mobile-view',
  templateUrl: './add-edit-bank-mobile-view.component.html',
  styleUrls: ['./add-edit-bank-mobile-view.component.scss']
})
export class AddEditBankMobileViewComponent implements OnInit {
  bankDetail: any;
  userData: any;
  holderList: any;
  bankList: any;
  ...
  @Input() set data(data) {
    ...
    if (this.userData.bankData == undefined) {
    ...
    if (this.bankForm.invalid) {
      ...
      let obj = {
        ...
        address: {
          ...
          addressId: (this.userData.bankData) ? this.userData.bankData.address.addressId : null
        },
        ...
        userBankMappingId: (this.userData.bankData) ? this.userData.bankData.userBankMappingId : null,
        bankId: (this.userData.bankData) ? this.userData.bankData.bankId : null,
        addressId: (this.userData.bankData) ? this.userData.bankData.address.addressId : null
      };
  ...
  showAllBankFields() {
    if (this.bankForm.controls.ifscCode.invalid) {
      this.bankForm.controls.ifscCode.markAsTouched();
      return;
    }
    this.showBankFields = true;
  }
