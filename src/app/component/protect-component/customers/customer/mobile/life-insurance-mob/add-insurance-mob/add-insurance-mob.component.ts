import { Component, OnInit, QueryList, ViewChildren, Input, ViewChild, ElementRef } from '@angular/core';
...
@Component({
  selector: 'app-add-insurance-mob',
  templateUrl: './add-insurance-mob.component.html',
  styleUrls: ['./add-insurance-mob.component.scss']
})
export class AddInsuranceMobComponent implements OnInit {
  ...
  constructor(private dialog: MatDialog, private enumService: EnumServiceService, private datePipe: DatePipe, private eventService: EventService, private fb: FormBuilder, private customerService: CustomerService) {
  }
  ...
  @Input() set data(data) {
    ...
    this.insuranceSubTypeId = (data == 'Term insurance') ? 1 : (data.inputData == 'Traditional insurance') ? 2 : (data.inputData == 'ULIP insurance') ? 3 : 1  ;
