...
import { MfServiceService } from 'src/app/component/Services/mf-service.service';
...
export class MutualFundsComponent implements OnInit {
  ...
  asyncFilter(mutualFund, categoryList) {
    if (typeof Worker !== 'undefined') {
      ...
      // Create a new
      // this.worker = new Worker('src/app/component/protect-component/customers/customer/mobile/mutual-fund.worker.ts', { type: 'module' });
