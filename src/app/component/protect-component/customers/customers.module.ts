...
@NgModule({
  declarations: [CustomerComponent, TransactionSuccessfulComponent,
    ...
    AddEditBankMobileViewComponent, AddEditDematMobileViewComponent, AddEditDocumentMobileViewComponent,
    MobileViewAddressComponent, MobileViewBankComponent, MobileViewDematComponent,RetirementAccMobComponent],
  imports: [
    // BrowserModule,
    CommonModule,
    MaterialModule,
