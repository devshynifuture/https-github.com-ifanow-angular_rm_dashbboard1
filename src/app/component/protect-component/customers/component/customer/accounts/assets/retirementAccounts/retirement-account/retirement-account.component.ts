...
export class RetirementAccountComponent implements OnInit {
  ...
  @ViewChild('epfListTable') epfListTableSort: MatSort;
  @ViewChild('npsListTable') npsListTableSort: MatSort;
  @ViewChild('gratuityListTable') gratuityListTableSort: MatSort;
  @ViewChild('superAnnuationListTable') superAnnuationListTableSort: MatSort;
  @ViewChild('epsListTable') epsListTableSort: MatSort;
  @ViewChild('EPF') EPF: ElementRef;
  @ViewChild('NPS') NPS: ElementRef;
  @ViewChild('Superannuation') Superannuation: ElementRef;
  @ViewChild('Gratuity') Gratuity: ElementRef;
  @ViewChild('EPS') EPS: ElementRef;
