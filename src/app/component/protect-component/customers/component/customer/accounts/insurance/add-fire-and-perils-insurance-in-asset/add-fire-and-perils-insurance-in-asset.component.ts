...
export class AddFireAndPerilsInsuranceInAssetComponent implements OnInit {
  ...
  get insuredMembersForm() {
    return this.fireInsuranceForm.get('InsuredMemberForm') as FormArray;
  }
  get planFeatureForm() {
  ...
  removeTransaction(item) {
    let finalMemberList = this.fireInsuranceForm.get('InsuredMemberForm') as FormArray 
  ...
  saveFireInsurance() {
    ...
    if (this.fireInsuranceForm.invalid) {
      ...
      const obj = {
        ...
        "cumulativeBonus": this.fireInsuranceForm.get('cumulativeBonus').value,
        "cumulativeBonusRupeesOrPercent": this.fireInsuranceForm.get('bonusType').value,
        "policyTypeId": this.fireInsuranceForm.get('PlanType').value,
        "deductibleSumInsured": this.fireInsuranceForm.get('deductibleAmt').value,
        "exclusion": this.fireInsuranceForm.get('exclusion').value,
        "copay": this.fireInsuranceForm.get('copay').value,
        "planName": this.fireInsuranceForm.get('planeName').value,
        "policyNumber": this.fireInsuranceForm.get('policyNum').value,
        "copayRupeesOrPercent": this.fireInsuranceForm.get('copayType').value,
        "tpaName": this.fireInsuranceForm.get('tpaName').value,
        "advisorName": this.fireInsuranceForm.get('advisorName').value,
        "serviceBranch": this.fireInsuranceForm.get('serviceBranch').value,
        "linkedBankAccount": this.fireInsuranceForm.get('bankAccount').value,
        "insurerName": this.fireInsuranceForm.get('insurerName').value,
        "policyInceptionDate": this.fireInsuranceForm.get('inceptionDate').value,
        "insuranceSubTypeId": this.inputData.insuranceSubTypeId,
        "planFeature":featureList,
        "addOns": [{
          "addOnId": this.fireInsuranceForm.get('additionalCovers').value,
          "addOnSumInsured": this.fireInsuranceForm.get('coversAmount').value
        }],
