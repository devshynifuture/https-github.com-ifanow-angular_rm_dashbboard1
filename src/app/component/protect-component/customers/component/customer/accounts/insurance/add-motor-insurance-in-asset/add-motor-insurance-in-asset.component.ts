...
export class AddMotorInsuranceInAssetComponent implements OnInit {
  ...
  getdataForm(data) {
    ...
    this.motorInsuranceForm = this.fb.group({
      ...
      registrationNumber: [(this.dataForEdit ? this.dataForEdit.vehicleRegNo : '')],
      registrationDate: [this.dataForEdit ? new Date(this.dataForEdit.vehicleRegistrationDate) : ''],
      modelName: [(this.dataForEdit ? this.dataForEdit.vehicleModel : '')],
      engineNumber: [(this.dataForEdit ? this.dataForEdit.engineNo : '')],
      chassisNumber: [(this.dataForEdit ? this.dataForEdit.chasisNo : '')],
      fuelType: [this.dataForEdit ? this.dataForEdit.fuelTypeId + '' : ''],
      cgGvw: [(this.dataForEdit ? this.dataForEdit.cgGvw : '')],
      claimBonus: [(this.dataForEdit ? this.dataForEdit.noClaimBonus : '')],
      discount: [(this.dataForEdit ? this.dataForEdit.specialDiscount : '')],
