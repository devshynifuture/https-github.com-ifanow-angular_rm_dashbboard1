...
export class AddMotorInsuranceInAssetComponent implements OnInit {
  ...
  get insuredMembersForm() {
    return this.motorInsuranceForm.get('InsuredMemberForm') as FormArray;
  }
  get getCoOwner() {
  ...
  getdataForm(data) {
    ...
    this.motorInsuranceForm = this.fb.group({
      ...
      vehicleType: [this.dataForEdit ? this.dataForEdit.vehicleType + '' : ''],
      registrationNumber: [(this.dataForEdit ? this.dataForEdit.registrationNumber : ''), [Validators.required]],
      registrationDate: [this.dataForEdit ? new Date(this.dataForEdit.registrationDate) : '', [Validators.required]],
      modelName: [(this.dataForEdit ? this.dataForEdit.modelName : ''), [Validators.required]],
      engineNumber: [(this.dataForEdit ? this.dataForEdit.engineNumber : ''), [Validators.required]],
      chassisNumber: [(this.dataForEdit ? this.dataForEdit.chassisNumber : ''), [Validators.required]],
      fuelType: [this.dataForEdit ? this.dataForEdit.fuelType + '' : ''],
      cgGvw: [(this.dataForEdit ? this.dataForEdit.cgGvw : ''), [Validators.required]],
      claimBonus: [(this.dataForEdit ? this.dataForEdit.claimBonus : ''), [Validators.required]],
      discount: [(this.dataForEdit ? this.dataForEdit.discount : ''), [Validators.required]],
      exclusion: [this.dataForEdit ? this.dataForEdit.exclusion :''],
      financierName: [this.dataForEdit ? this.dataForEdit.financierName :''],
  ...
  removeTransaction(item) {
    let finalMemberList = this.motorInsuranceForm.get('InsuredMemberForm') as FormArray 
  ...
  saveHealthInsurance() {
    ...
    if (this.motorInsuranceForm.invalid) {
      ...
      const obj = {
        ...
        "cumulativeBonus": this.motorInsuranceForm.get('cumulativeBonus').value,
        "cumulativeBonusRupeesOrPercent": this.motorInsuranceForm.get('bonusType').value,
        "policyTypeId": this.motorInsuranceForm.get('PlanType').value,
        "deductibleSumInsured": this.motorInsuranceForm.get('deductibleAmt').value,
        "exclusion": this.motorInsuranceForm.get('exclusion').value,
        "copay": this.motorInsuranceForm.get('copay').value,
        "planName": this.motorInsuranceForm.get('planeName').value,
        "policyNumber": this.motorInsuranceForm.get('policyNum').value,
        "copayRupeesOrPercent": this.motorInsuranceForm.get('copayType').value,
        "tpaName": this.motorInsuranceForm.get('tpaName').value,
        ...
        "policyInceptionDate": this.motorInsuranceForm.get('inceptionDate').value,
        "insuranceSubTypeId": this.inputData.insuranceSubTypeId,
        "addOns": [{
          "addOnId": this.motorInsuranceForm.get('additionalCovers').value,
          "addOnSumInsured": this.motorInsuranceForm.get('coversAmount').value
        }],
