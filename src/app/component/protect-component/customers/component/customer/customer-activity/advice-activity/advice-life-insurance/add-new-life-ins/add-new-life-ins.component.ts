...
@Component({
  selector: 'app-add-new-life-ins',
  templateUrl: './add-new-life-ins.component.html',
  styleUrls: ['./add-new-life-ins.component.scss']
})
export class AddNewLifeInsComponent implements OnInit {
