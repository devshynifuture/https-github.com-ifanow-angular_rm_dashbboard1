...
export class CustomerService {
  ...
  getLifeInsuranceData(data) {
    const httpParams = new HttpParams().set('advisorId', data.advisorId).set('id', data.id).set('clientId', data.clientId).set('insuranceSubTypeId', data.insuranceSubTypeId).set('insuranceTypeId', data.insuranceTypeId);
  ...
  getClientUploadFile(data) {
    return this.http.getEncoded(apiConfig.MAIN_URL + appConfig.GET_CLIENT_UPLOAD_FILE, data, 1);
  ...
  getPortfolioDataList(data) {
    const httpParams = new HttpParams().set('advisorId', data.advisorId).set('clientId', data.clientId);
    return this.http.get(apiConfig.MAIN_URL + appConfig.GET_PORTFOLIODATA_LIST, data);
  }
  ...
  filterScripList(data) {
    return this.http.get(apiConfig.MAIN_URL + appConfig.GET_SCRIP_FILTER, data);
  }
  ...
  deletePortfolio(data) {
    return this.http.put(apiConfig.MAIN_URL + appConfig.DELETE_PORTFOLIO, data);
  }
  ...
  getElssTransacitonReport(data) {
    // return this.http.get(apiConfig.MAIN_URL + appConfig.MUTUAL_FUND_GET, data);
    return this.http.get(apiConfig.MF_URL + appConfig.ELSS_TRANSACTIONS, data);
  }
