...
@Component({
  selector: 'app-add-real-estate-mob',
  templateUrl: './add-real-estate-mob.component.html',
  styleUrls: ['./add-real-estate-mob.component.scss']
})
export class AddRealEstateMobComponent implements OnInit {
