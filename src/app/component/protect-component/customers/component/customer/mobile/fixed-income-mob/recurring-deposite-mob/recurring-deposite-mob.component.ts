...
@Component({
  selector: 'app-recurring-deposite-mob',
  templateUrl: './recurring-deposite-mob.component.html',
  styleUrls: ['./recurring-deposite-mob.component.scss']
})
export class RecurringDepositeMobComponent implements OnInit {
