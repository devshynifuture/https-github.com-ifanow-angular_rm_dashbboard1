...
export class CashflowsPlanComponent implements OnInit {
  ...
  displayedColumnsIncome: string[] = ['position', 'name', 'weight', 'symbol', 'symbol2', 'symbol3', 'symbol4', 'symbol5', 'symbol6', 'symbol7', 'symbol8', 'symbol9', 'symbol10'];
...
const ELEMENT_DATAIncome: PeriodicElementIncome[] = [
  {
    ...
    symbol4: '40,000', symbol5: '40,000', symbol6: '40,000', symbol7: '40,000', symbol8: '40,000', symbol9: '40,000', symbol10: '40,000',
  },
