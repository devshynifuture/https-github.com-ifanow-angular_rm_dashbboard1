...
export class FinacialPlanSectionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getLibilities()
    this.isLoading = true
    this.emailBody = '<html><body><img src="https://res.cloudinary.com/futurewise/image/upload/v1491912047/fp-templates-uploads/index.jpg" width="965px" height="1280px"><div style="position: absolute;top: 18px;left: 16px;font-size: 20;"> <b>Date: ' + this.datePipe.transform(new Date(), 'yyyy-MM-dd') + '</b></div><div style="position: absolute;top: 18px;right: 18px;"> <img _ngcontent-hwm-c87="" width="140px" src=' + (this.getOrgData.reportLogoUrl) ? this.getOrgData.reportLogoUrl : this.getOrgData.logoUrl + ' class="ng-star-inserted"></div><div style="position: absolute;top: 200px;right: 18px;font-size: 20;"> <b>Prepared by: ' + this.userInfo.name + '</b></div><div style="position: absolute;top: 280px;right: 18px;font-size: 20;"> <b>' + this.clientData.name + '`s Plan</b></div></body></html>'
    //this.pdfFromImage()
