...
@Component({
  selector: 'app-other-insurance-insurance-planning',
  templateUrl: './other-insurance-insurance-planning.component.html',
  styleUrls: ['./other-insurance-insurance-planning.component.scss']
})
export class OtherInsuranceInsurancePlanningComponent implements OnInit {
  ...
  saveOthersInsurance() {
    ...
    if (this.otherAssetForm.invalid) {
      ...
      console.log(obj);
      // if (obj && obj.hasOwnProperty('otherInsuranceInsuredMembers') && obj.otherInsuranceInsuredMembers.length > 0) {
      //   obj.otherInsuranceInsuredMembers.forEach(ele => {
      //     this.ownerIds.push({
